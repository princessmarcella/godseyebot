...
import godseye.modules.sql.welcome_sql as sql
import godseye.modules.sql.global_bans_sql as gbansql
import godseye.modules.sql.users_sql as userssql
import godseye.modules.sql.feds_sql as feds_sql

from godseye import dispatcher, OWNER_ID, LOGGER, SUDO_USERS, SUPPORT_USERS, DEV_USERS, WHITELIST_USERS, MESSAGE_DUMP
from godseye.modules.helper_funcs.chat_status import user_admin, can_delete, is_user_ban_protected
from godseye.modules.helper_funcs.misc import build_keyboard, revert_buttons, send_to_list
from godseye.modules.helper_funcs.msg_types import get_welcome_type
...
from godseye.modules.helper_funcs.string_handling import markdown_parser, escape_invalid_curly_brackets
from godseye.modules.log_channel import loggable
      ...
      #  bantime = int(time.time()) + 60
       # chat.kick_member(user.id, until_date=bantime)
        ...
        for new_mem in new_members:
            ...
            elif new_mem.id == 871498658:
                update.effective_message.reply_text("OMG😍😘,My Creator/Maker has just joined your group.")
