...
from godseye import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from godseye.modules.helper_funcs.chat_status import user_admin, sudo_plus
...
def music(bot: Bot, update: Update, args):
	...
	if not json1_response['error']:
		...
		if not json2_response['error']:
			...
			info = '*{0}* \nUploaded by godseye'.format(payload['fulltitle'])
