...
from godseye import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL
from godseye.modules import ALL_MODULES
from godseye.modules.helper_funcs.chat_status import is_user_admin
from godseye.modules.helper_funcs.misc import paginate_modules
from godseye.modules.connection import connected
from godseye.modules.connection import connect_button
...
*You will get my daily updates at @Gods_eye_bot*
"""
...
🔈If U Want Any Support Or Have Any Query Related to Bot u can visit @me_harry
...
if START_IMG is None:
    img = "https://telegra.ph/file/53ec2d560df37d380e1e3.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("godseye.modules." + module_name)
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get Instant help.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Help",url="t.me/{}?start=help".format(bot.username))],
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/me_harry")]]))
