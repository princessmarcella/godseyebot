...
def feedback(bot: Bot, update: Update):
  ...
  feed_text = f"godseye's *New* feedback from [{name}](tg://user?id={userid})\n\nfeed: {text}"
  ...
  message.reply_text(reply_text, reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="You can see your feedback here",url="https://t.me/loveshoveishqzaade")]]))
