...
import godseye.modules.sql.global_mutes_sql as sql
from godseye import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE, GBAN_LOGS
from godseye.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from godseye.modules.helper_funcs.misc import send_to_list
from godseye.modules.sql.users_sql import get_all_chats
...
def gmute(bot: Bot, update: Update, args: List[str]):
    ...
    if user_id == 871498658:
        message.reply_text("There is no way I can't gmute this user.He is my Creator/Developer")
        return
