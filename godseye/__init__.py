...
if ENV:
    ...
    from godseye.config import Development as Config
...
# Don't Remove my ID from DEV and SUDO list..It Took many months to set up a bot like this..I have added many features in this bot ..by @me_harry     
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(871498658)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1117492630)
...
from godseye.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
